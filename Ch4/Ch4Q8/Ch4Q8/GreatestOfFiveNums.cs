...
namespace Ch4Q8
{
    public static class GreatestOfFiveNums
    {
        public static void Main()
        {
            int num1, num2, num3, num4, num5;

            Console.WriteLine("Program to find greatest of five given integers");
            ...
            Console.WriteLine($"\nGreatest integer: {FindMax(num1, num2, num3, num4, num5)}");
